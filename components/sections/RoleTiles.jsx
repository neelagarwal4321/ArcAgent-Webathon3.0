        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {ROLES.map((r, i) => (
            <ScrollReveal key={r.role} delay={i * 0.08}>
              <div className="bg-surface-1 rounded-card shadow-card border border-[rgba(10,15,44,0.06)] p-7 h-full hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-250">
