        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          {STEPS.map((s, i) => (
            <ScrollReveal key={s.step} delay={i * 0.1}>
              <div className="bg-surface-1 rounded-card shadow-card border border-[rgba(10,15,44,0.06)] p-7 relative hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-250">
