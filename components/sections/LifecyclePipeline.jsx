        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          {STAGES.map((s, i) => (
            <ScrollReveal key={s.title} delay={i * 0.1}>
              <div className={`relative rounded-card shadow-card border p-7 z-10 hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-[250ms] ${i === 0 ? 'border-primary/30 bg-surface-1' : 'bg-surface-1 border-[rgba(10,15,44,0.06)]'}`}>
