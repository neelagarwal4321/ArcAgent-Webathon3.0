...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      ...
      {/* ── Hero ── */}
      <section className="pt-[64px] md:pt-[80px] lg:pt-[120px] pb-0" style={{ background: '#0A0F2C' }}>
      ...
      {/* ── Content ── */}
      <section className="pt-12 pb-[64px] md:pb-[80px] lg:pb-[120px]" style={{ background: '#0A0F2C' }}>
